...
from legal_rag.retrieval.hybrid_search import HybridSearcher, rrf_fusion
...
class TestEmbedderDryRun:
    ...
    def test_format_document_contains_law_fields(self, default_config, sample_articles):
        ...
        assert art["law_type"] in formatted
        assert art["law_name"] in formatted
...
class TestConfigLoad:
    ...
    def test_load_from_yaml(self):
        config_path = Path(__file__).resolve().parent.parent / "config_gpu_clean.yaml"
